...
import com.techblog.blogtech.mappers.CommentMapper;
...
public class CommentService extends MainService<CommentDto, Long, Comment> {
    ...
    public CommentService(JpaRepositoryImplementation<Comment, Long> repository, MainMapper<CommentDto, Comment> mapper, CommentRepository repository1, CommentMapper mapper1) {
    ...
    public Page<CommentDto> getCommentsByAuthorId(Long id, Pageable pageable) {
        ...
        return commentsByAuthorId.map(mapper::toDto);
    }
    ...
    public Page<CommentDto> getCommentsByPostId(Long id, Pageable pageable) {
        ...
        return commentsByPostId.map(mapper::toDto);
    }
}
